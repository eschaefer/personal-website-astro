...
I stumbled upon an excellent tutorial in TensorFlow's documentation for [classifying audio](https://www.tensorflow.org/hub/tutorials/yamnet) using the YAMNet model. This model conveniently includes a subset of sirens in its training data. Perfect!
